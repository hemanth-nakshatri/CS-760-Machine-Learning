...
class QLearning(AbstractSolver):
    ...
    def train_episode(self):
        ...
        total_reward = 0
        action_table = []   # For MDP (Question 4) only
        ...
        #### Custom MDP part for Question 4. Comment this section for Cliff_walking part #######
        print()
        print("Q(A, move): ", self.Q[0][0])
        print("Q(A, stay): ", self.Q[0][1])
        print("Q(B, move): ", self.Q[1][0])
        print("Q(B, stay): ", self.Q[1][1])
        ########################################################################
    ...
    def epsilon_greedy_action(self, state):
        ...
        # if np.random.rand() < self.options.epsilon:
        #     # return self.env.action_space.sample()
        #     return np.random.choice(2) # 4 for Cliff_walking, 2 for MDP
        # else:
        #     return np.argmax(self.Q[state])
        #####################################
